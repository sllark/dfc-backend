...
exports.encryptLabcorpPayload = encryptLabcorpPayload;
exports.decryptLabcorpPayload = decryptLabcorpPayload;
const crypto_1 = __importDefault(require("crypto"));
const ALGORITHM = "aes-256-gcm";
const IV_LENGTH = 12; // 12 bytes for GCM
const TAG_LENGTH = 16; // 16 bytes auth tag
function getLabcorpKey() {
    ...
    if (key.length !== 32) {
        throw new Error("LABCORP_PAYLOAD_PASSWORD must be a base64-encoded 32-byte key for AES-256-GCM.");
    }
    return key;
}
/**
 ...
 */
function encryptLabcorpPayload(plaintextObject) {
 ...
 */
function decryptLabcorpPayload(encryptedResponse) {
    const key = getLabcorpKey();
...
//# sourceMappingURL=labcorpEncryption.js.map